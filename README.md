...
Utility tools for Jupyter notebooks and data workflows mainly build on top of code used in homeworks and tasks at UC Chile.
...
### From GitHub
```bash
pip install git+https://github.com/jj-sm/ipynb-jjsm-tools.git
```

### With uv
```bash
uv pip install git+https://github.com/jj-sm/ipynb-jjsm-tools.git
```
...
[Juan José Sánchez Medina](https://github.com/jj-sm/) - [Website](https://jjsm.science)